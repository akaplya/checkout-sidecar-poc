...
class ComplexProductPriceResolver implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        return [
            ...
            'maximum' => [
                'regular' => [
                    'amount' => $value['raw']['prices']['maximumPrice']['regularPrice'],
                    'currency' => $value['raw']['currency']
                ],
                'final' => [
                    'amount' => $value['raw']['prices']['maximumPrice']['finalPrice'],
                    'currency' => $value['raw']['currency']
                ]
            ],
        ];
